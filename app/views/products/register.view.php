        ...
        <form method="POST">
            <div class="row justify-content-center mb-2">
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" name="productCode" id="productCode" aria-describedby="productCodeHelp" placeholder="XXXX XXXX" value="<?= $this->product['productCode'] ?? null; ?>" />
                    <small id="productCodeHelp" class="form-text text-muted">Código de cadastro do produto</small>
                </div>
                <div class="col-md-9">
                    <label for="productName">Nome do Produto</label>
                    <input type="text" class="form-control" name="productName" id="productName" aria-describedby="productNameHelp" placeholder="Ex: Laranja, Maça, Pêssego" value="<?= $this->product['name'] ?? null; ?>" />
